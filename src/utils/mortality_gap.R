...
survival_coef <- sort(c(0.69, 0.63, 0.74, 0.99, 0.88, 0.82, 0.55))
...
tab_20_45[, 'Age group' := '20-45']
tab_20_70[, 'Age group' := '20-70']

tab_20_45 = tab_20_45[, c(6,1,2,3,4,5), with = FALSE]
tab_20_70 = tab_20_70[, c(6,1,2,3,4,5), with = FALSE]
